...
const LEVELS = [ // 0=playground, 1=wall, 2=box (playground bellow), 4=storage, 5=player (playground bellow), 8=outside world
    ...
    [ // level 2
      ...
      [8,8,1,0,0,0,1,1,1,1,8],
      [8,8,1,0,0,0,1,0,0,1,8],
      [8,8,1,1,0,0,0,0,4,1,8],
      [8,1,1,1,0,1,1,1,4,1,8],
      [8,1,0,2,0,1,8,1,4,1,8],
      [8,1,0,2,2,1,8,1,1,1,8],
      [8,1,5,0,0,1,8,8,8,8,8],
    ...
    [ // level 4
      ...
      [8,8,8,8,1,1,1,8,8,8,8,8,8],
      [8,8,8,1,1,0,1,8,1,1,1,1,8],
      [8,8,1,1,0,0,1,1,1,0,0,1,8],
      [8,1,1,0,2,0,0,0,0,0,0,1,8],
      [8,1,0,0,0,5,2,0,1,0,0,1,8],
      [8,1,1,1,0,2,1,1,1,0,0,1,8],
      [8,8,8,1,0,0,1,4,4,0,0,1,8],
      [8,8,1,1,0,1,1,4,1,0,1,1,8],
      [8,8,1,0,0,0,0,0,0,1,1,8,8],
      [8,8,1,0,0,0,0,0,1,1,8,8,8],
      [8,8,1,1,1,1,1,1,1,8,8,8,8],
      [8,8,8,8,8,8,8,8,8,8,8,8,8],
    ],
    [ // level 5      
